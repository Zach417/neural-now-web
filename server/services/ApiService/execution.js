...
function Executor () {
    ...
    this.httpOnEnd = function () {
        if (!this.chunks) {
            ...
            console.log("Plan Manager Server attempted to callback more than once.");
            return;
            ...
            throw new Error("Error executing plan manager service: Maximum try count of 5 reached.");
        }
    }
